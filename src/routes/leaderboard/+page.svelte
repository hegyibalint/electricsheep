...
import type { PageData } from './$types';
	...
	let array = [
		{username:"Alice", avatar:"./sheep-face.png", total_points: 1000, games_played:1500, success_ratio: 66, detected_humans: 33, detected_robots: 45, mistaken_robot: 10},
		{username:"Bob", avatar:"./old-sheep-face.png", total_points: 900, games_played:901, success_ratio: 99, detected_humans: 34, detected_robots: 44, mistaken_robot: 3},
		{username:"Charlie", avatar:"./openai-sheep-face.png", total_points: 888, games_played:1000, success_ratio: 88, detected_humans: 53, detected_robots: 15, mistaken_robot: 46},
		{username:"Doug", avatar:"./facebook-sheep-face.png", total_points: 765, games_played:2000, success_ratio: 38, detected_humans: 99, detected_robots: 0, mistaken_robot: 99},
		{username:"Eddy", avatar:"./github-sheep-face.png", total_points: 600, games_played:2500, success_ratio: 24, detected_humans: 3, detected_robots: 89, mistaken_robot: 30},
		{username:"Alice", avatar:"./sheep-face.png", total_points: 1000, games_played:1500, success_ratio: 66, detected_humans: 33, detected_robots: 45, mistaken_robot: 10},
		{username:"Bob", avatar:"./old-sheep-face.png", total_points: 900, games_played:901, success_ratio: 99, detected_humans: 34, detected_robots: 44, mistaken_robot: 3},
		{username:"Charlie", avatar:"./openai-sheep-face.png", total_points: 888, games_played:1000, success_ratio: 88, detected_humans: 53, detected_robots: 15, mistaken_robot: 46},
		{username:"Doug", avatar:"./facebook-sheep-face.png", total_points: 765, games_played:2000, success_ratio: 38, detected_humans: 99, detected_robots: 0, mistaken_robot: 99},
		...
		<table>
			<thead>
				<tr class="bg-amber-100">
					...
					<th on:click={sort("detected_humans")}>Detected Human</th>
					<th on:click={sort("detected_robots")}>Detected Robot</th>
					<th on:click={sort("mistaken_robot")}>Mistaken for Robot</th>
				</tr>
			</thead>
			<tbody>
				{#each array as row}
